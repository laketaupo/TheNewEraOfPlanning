...
"people-01-planning-team/planning-roles-overview.md": {
	id: "people-01-planning-team/planning-roles-overview.md";
  slug: "people-01-planning-team/planning-roles-overview";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"people-01-planning-team/role-competencies.md": {
	id: "people-01-planning-team/role-competencies.md";
  slug: "people-01-planning-team/role-competencies";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
...
"people-04-roles-overview/01-placeholder.md": {
	id: "people-04-roles-overview/01-placeholder.md";
  slug: "people-04-roles-overview/01-placeholder";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
