---
title: "Creating a Scenario in Planning software"
description: "A scenario in Planning software starts as a copy of the baseline plan. This topic covers how to create one, name it, and scope it correctly before making any changes."
...
In Planning software, creating a scenario copies the current baseline planning model into an isolated workspace. Changes you make inside the scenario do not affect the baseline — the two exist in parallel. You can have multiple scenarios active at the same time, all branching from the same baseline.
...
Navigate to the Scenarios module in Planning software. Select **New Scenario** and provide:
