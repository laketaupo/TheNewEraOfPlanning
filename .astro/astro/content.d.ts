...
"03-demand-data-flow/01-demand-signal.md": {
	id: "03-demand-data-flow/01-demand-signal.md";
  slug: "03-demand-data-flow/01-demand-signal";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"03-demand-data-flow/02-forecast-origin.md": {
	id: "03-demand-data-flow/02-forecast-origin.md";
  slug: "03-demand-data-flow/02-forecast-origin";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"03-demand-data-flow/03-upstream-cascade.md": {
	id: "03-demand-data-flow/03-upstream-cascade.md";
  slug: "03-demand-data-flow/03-upstream-cascade";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"03-demand-data-flow/04-timing-and-netting.md": {
	id: "03-demand-data-flow/04-timing-and-netting.md";
  slug: "03-demand-data-flow/04-timing-and-netting";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
...
"04-supply-data-flow/01-supply-signal.md": {
	id: "04-supply-data-flow/01-supply-signal.md";
  slug: "04-supply-data-flow/01-supply-signal";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"04-supply-data-flow/02-inventory-netting.md": {
	id: "04-supply-data-flow/02-inventory-netting.md";
  slug: "04-supply-data-flow/02-inventory-netting";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"04-supply-data-flow/03-parent-line-items.md": {
	id: "04-supply-data-flow/03-parent-line-items.md";
  slug: "04-supply-data-flow/03-parent-line-items";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
"04-supply-data-flow/04-downstream-cascade.md": {
	id: "04-supply-data-flow/04-downstream-cascade.md";
  slug: "04-supply-data-flow/04-downstream-cascade";
  body: string;
  collection: "chapters";
  data: any
} & { render(): Render[".md"] };
